  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50 flex items-center justify-center p-4 sm:p-6 lg:p-8">
      ...
      <div className="relative w-full max-w-sm sm:max-w-md mx-auto">
        ...
        {/* Custom styled Clerk SignUp - Centered container */}
            ...
            <SignUp 
              ...
              appearance={{
                elements: {
                  ...
                  formFieldHintText: "text-slate-500 text-xs sm:text-sm",
        ...
        <div className="text-center mt-6 sm:mt-8 px-2">
          <p className="text-slate-500 text-sm sm:text-base">
            ...
            <Link href="/sign-in" className="text-indigo-600 hover:text-indigo-700 font-semibold transition-colors touch-manipulation">
              Sign In
            </Link>
          </p>
        </div>
